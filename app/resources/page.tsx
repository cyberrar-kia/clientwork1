...
const drawerContent: Record<string, DrawerItem> = {
  "Phonics Chart — Sets 1–9": { title:"Phonics Chart — Sets 1–9", body:"The official Client Work Phonics Chart covering all 9 phoneme sets plus a bonus letter sound. As provided by the Ministry of Education, Skills, Youth and Information.", bullets:["Set 1: s, short ă, m, short ĕ, p","Set 2: f, n, short ĭ, t, r","Set 3: d, short ŏ, hard g, h, k","Set 4: l, b, short ŭ, soft g, long ā","Set 5: j, long ī, or, long ō, z","Set 6: ng, w/wh, short oo, long oo, v","Set 7: ch, sh, long ē, th, y","Set 8: x, qu, oi, long ū, ar","Set 9: ow, ou, er, zh","Bonus letter sound: soft c"] },
  ...
  "Assessment & Progress Monitoring Tools": { title:"Assessment & Progress Monitoring Tools", body:"Built-in assessment tools including Client Work Poster Fluency Tests, self-assessment checklists, and progress tracking sheets. Measurable outcomes at every stage.", bullets:["Client Work Poster Fluency Tests — Step 16 of every lesson","Self-assessment and reward sticker system","Parent/teacher progress notes","Standardised review before progression","Built-in progress monitoring and measurable outcomes","Reward stickers tied to every milestone"] },
  "iCW™ AI-Powered Robot": { title:"iCW™ — Patent-Pending AI-Powered Robot", body:"Our patent-pending, AI-powered Smart Edutainment Robot for Kids. The Teacher's Helper and Your Child's Learning Companion. Smart devices and AI tools support student assessment and track fluency.", bullets:["Patent-pending AI-powered robot with integrated Client Work content","Smart devices and AI tools support student assessment and track fluency","Voice assistant — just say iCW™","Preloaded educational apps","Sing-along with two microphones","Cast to TV for classroom activities","Inclusive design: supports children with visual impairments, speech delays, and limited motor skills"] },
  "Client Work Apps": { title:"Client Work Apps", body:"Digital apps for independent practice, phoneme reinforcement, and parent engagement. Available on tablets and compatible devices.", bullets:["Independent phoneme practice","Parent engagement tools","Tablet-compatible for classroom and home use","Part of the full iCW™ technology ecosystem","Combines physical books with apps and AI tools","Innovative AI tool for comprehensive learning"] },
  "National Literacy Competition Cards": { title:"National Literacy Competition Cards", body:"Cards and materials for classroom and national literacy competitions — building motivation, fluency, and confidence. Supports national literacy initiatives.", bullets:["Designed for classroom and national literacy competitions","Builds motivation, fluency, and reading confidence","Supports national literacy initiatives","Community engagement and nation-building focus","Aligned to the Client Work programme scope and sequence","Reward and recognition built in"] },
  "ANNA-WARRIOR — Reggae Phoneme Song": { title:"ANNA-WARRIOR — Reggae Phoneme Song", body:"A one-minute reggae phoneme song from the Client Work collection. Rhythmic, memorable, and fun — helping children learn sounds through music.", bullets:["Call-and-response rhythmic structure","Reinforces phoneme recognition","Evidence-based: rhythmic learning improves retention","Available as audio download"] },
  "BIG FISH-WARRIOR — Reggae Phoneme Song": { title:"BIG FISH-WARRIOR — Reggae Phoneme Song", body:"A one-minute reggae phoneme song from the Client Work collection. Part of the 45 reggae phoneme songs programme.", bullets:["Call-and-response rhythmic structure","Reinforces phoneme recognition","Part of the 45 phoneme songs collection","Available as audio download"] },
  "BLACK BIRD — Reggae Phoneme Song": { title:"BLACK BIRD — Reggae Phoneme Song", body:"A one-minute reggae phoneme song from the Client Work collection. Children wake up singing these songs!", bullets:["Call-and-response rhythmic structure","Reinforces phoneme recognition","Part of the 45 phoneme songs collection","Available as audio download"] },
  "All CW Reader & C-DER Books": { title:"All CW Reader & C-DER Books", body:"70+ decodable readers published by Client Work Purrrrrrr Publishing. CW Reader books are culturally authentic Jamaican stories; CWR books extend across the Caribbean. Both series are fully decodable, phonics-aligned, and available in sets.", bullets:["Fiction and nonfiction titles","All levels from emergent to fluent","Culturally authentic illustrations","Available individually or in sets","Compatible with the Client Work programme"] },
  ...
  "Client Work Charts — Multisensory Reinforcement Tools": { title:"Client Work Charts — Multisensory Reinforcement Tools", body:"Physical chart resources specifically designed as multisensory reinforcement tools, complementing the 27+ interactive charts with tactile and visual learning support.", bullets:["Multisensory reinforcement tools for letter-sound connections","Support phoneme recall through visual and kinaesthetic engagement","Used alongside the 27+ interactive charts in the classroom","Designed for whole-class and small-group instruction","Aligns to the 16-step instructional sequence","Available as part of the full Client Work resource ecosystem"] },
  "Innovative AI Tool": { title:"Innovative AI Tool", body:"An innovative AI-powered learning tool that extends beyond the iCW™ device — integrating artificial intelligence into the literacy ecosystem to support student assessment, track fluency, and personalise learning.", bullets:["AI-powered learning and assessment capabilities","Tracks student fluency progress over time","Personalises instruction based on individual student data","Integrates with iCW™ devices and digital apps","Supports teachers with data-driven instructional decisions","Part of the full Client Work technology ecosystem"] },
  "Teacher Training": { title:"Teacher Training", body:"Comprehensive teacher training programmes designed to equip educators with the knowledge, tools, and confidence to implement Client Work successfully in their classrooms.", bullets:["Full programme implementation training for classroom teachers","'Train-the-trainer' model for school-wide rollout","Intensive Transformation Weeks for rapid upskilling","Ongoing classroom assistance and support","Aligned to the 16-step instructional sequence","Available in-person and digitally for schools across Jamaica, USA, and Africa"] },
};

const resources = [
  { cat:"Phonics", icon:"📊", audience:"both", image:"/images/resources/phonics-chart-preview.jpg", title:"Phonics Chart — Sets 1–9", desc:"Official Client Work Phonics Chart — 9 phoneme sets plus bonus sound, as provided by the Ministry of Education, Skills, Youth and Information.", tag:"orange", type:"PDF Download", downloadUrl:"/phonics-chart.pdf" },
  ...
  { cat:"Decodable Books", icon:"📖", audience:"parent", image:"/images/resources/poster-stories.jpg", title:"Client Work Poster Stories — Level 1", desc:"9 Level 1 decodable books for early readers just beginning to decode. Large, poster-format stories ideal for classroom shared reading.", tag:"blue", type:"Physical Book" },
  { cat:"Decodable Books", icon:"📚", audience:"parent", image:"/images/resources/cder-books.jpg", title:"Client Work Decodable & Early Readers — Level 2", desc:"70+ Level 2 decodable books for building decoding and fluency. Fiction and nonfiction titles across a range of topics.", tag:"green", type:"Physical Book" },
  ...
  { cat:"Assessment", icon:"📋", audience:"teacher", title:"Assessment & Progress Monitoring Tools", desc:"Built-in assessment tools including Client Work Poster Fluency Tests, self-assessment checklists, and progress tracking sheets.", tag:"green", type:"Assessment" },
  { cat:"Technology", icon:"🤖", audience:"both", image:"/images/icheetah-frontal.png", title:"iCW™ AI-Powered Robot", desc:"Patent-pending AI-powered robot with integrated Client Work content. Engages children in interactive literacy activities through voice and screen.", tag:"orange", type:"Hardware" },
  { cat:"Technology", icon:"📱", audience:"both", image:"/images/resources/cheetah-app.jpg", title:"Client Work Apps", desc:"Digital apps for independent practice, phoneme reinforcement, and parent engagement. Available on tablets and compatible devices.", tag:"blue", type:"Digital App" },
  ...
  { cat:"Books", icon:"📗", audience:"both", image:"/images/resources/cder-books.jpg", title:"All CW Reader & C-DER Books", desc:"70+ decodable readers — CW Reader (Jamaica) and CWR (Caribbean) series. Fiction and nonfiction across all levels and cultural contexts.", tag:"green", type:"Book Collection" },
  ...
  { cat:"Charts & Visual Tools", icon:"📌", audience:"teacher", image:"/images/resources/interactive-charts.png", title:"Client Work Charts — Multisensory Reinforcement Tools", desc:"Physical chart resources designed as multisensory reinforcement tools — supporting phoneme recall through visual and kinaesthetic engagement alongside the 27+ interactive charts.", tag:"blue", type:"Physical Resource" },
  ...
  { cat:"Training", icon:"🎓", audience:"teacher", title:"Teacher Training", desc:"Comprehensive teacher training including 'train-the-trainer' programmes and intensive Transformation Weeks — equipping educators to implement Client Work with confidence.", tag:"green", type:"Professional Development" },
];
    ...
    <div style={{ background:"white", border:"1px solid #EDE0D0", borderRadius:20, overflow:"hidden", boxShadow:"0 4px 24px rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ padding:"clamp(20px,4%,32px)", minHeight:320, display:"flex", flexDirection:"column", justifyContent:"space-between" }}>
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:16 }}>
                ...
                <div>
                  <div style={{ fontFamily:"'Nunito',sans-serif", fontWeight:900, fontSize:11, color:book.accent, letterSpacing:"0.5px", textTransform:"uppercase" }}>CW Reader</div>
      ...
      <div style={{ padding:"14px 18px", borderTop:"1px solid #EDE0D0" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
          ...
          <span style={{ background:book.color, color:"#0C2340", fontSize:10, fontWeight:700, padding:"3px 10px", borderRadius:50 }}>CW Reader</span>
        </div>
        {/* Navigation */}
    ...
    <>
      <section className="section" style={{ background:"linear-gradient(135deg,#0C2340,#1A3A70)", padding:"80px 24px 60px", textAlign:"center" }}>
        <div className="container-sm">
          ...
          <p style={{ fontSize:"clamp(14px,2vw,17px)", color:"rgba(255,255,255,0.8)", lineHeight:1.8 }}>Over 90 carefully designed resources spanning books, songs, technology, charts, and assessment tools — all aligned to the Client Work system.</p>
        </div>
      </section>
      ...
      <section className="section" style={{ background:"#F0FDF4", display: audience==="teacher"||audience==="all" ? "block" : "none" }} id="educators">
        <div className="container">
          <div style={{ marginBottom:32 }}>
            ...
            <p style={{ fontSize:"clamp(13px,1.5vw,15px)", color:"#8A7A6A", marginTop:6 }}>Structured lesson guides, phonics charts, assessments, and training materials to deliver Client Work with confidence.</p>
          </div>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(clamp(220px,26vw,280px),1fr))", gap:16 }}>
            {[
              ...
              { icon:"📊", image:"/images/resources/phonics-chart-preview.jpg", title:"Client Work Phonics Chart", desc:"Official Ministry of Education approved phonics chart covering all 9 phoneme sets plus a bonus letter sound. Print-ready PDF.", free:true },
              { icon:"📝", title:"Assessment & Progress Tools", desc:"Client Work Poster Fluency Tests, self-assessment checklists, and progress tracking sheets. Measurable outcomes at every stage." },
        ...
        <div className="container">
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(clamp(220px,26vw,280px),1fr))", gap:16 }}>
            {[
              ...
              { icon:"📖", image:"/images/resources/cder-books.jpg", title:"CW Reader & C-DER Books", desc:"70+ culturally authentic decodable early readers. Fiction and nonfiction across all reading levels. Ideal for reading together at home." },
              ...
              { icon:"📊", title:"Home Progress Guide", desc:"Simple parent-friendly guide to tracking your child's reading progress at home alongside the Client Work programme.", contactUs:true },
              { icon:"🤖", image:"/images/icheetah-frontal.png", title:"iCW™ AI Device", desc:"AI-powered reading companion for children ages 3–8. Guides phonics practice and adapts to each child's pace." },
            ].map(item => (
              <div key={item.title} style={{ background:"white", border:"1px solid #EDE0D0", borderRadius:16, overflow:"hidden" }}>
                {(item as any).image && (
                  <div style={{ width:"100%", height:140, background:"white", display:"flex", alignItems:"center", justifyContent:"center", borderBottom:"1px solid #EDE0D0", padding:10, boxSizing:"border-box" }}>
        ...
        <div className="container">
          <div className="grid-2" style={{ marginBottom:48, gap:40, alignItems:"center" }}>
            <div>
              ...
              <h3 style={{ fontFamily:"'Nunito',sans-serif", fontWeight:900, fontSize:24, color:"#0C2340", marginBottom:14 }}>Meet iCW™</h3>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:20 }}>
                {["🎙️ Voice assistant — just say iCW™","📱 Preloaded educational apps","🎵 Sing-along with two microphones","📺 Cast to TV for classroom activities","🎮 Explore shapes, numbers & colours","📚 STEM literacy & learning kits"].map(f=>(
                  <div key={f} style={{ fontSize:13, color:"#5A5240" }}>{f}</div>
                ))}
              </div>
            </div>
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              <Image src="/images/girl-with-icheetah.png" alt="Child hugging iCW™ Robot" width={400} height={500} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.1)" }} />
              <Image src="/images/icheetah-frontal.png" alt="iCW™ Robot" width={400} height={300} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.1)" }} />
            </div>
          </div>
          <div style={{ marginBottom:48 }}>
            <Image src="/images/icheetah-features.png" alt="iCW Features" width={1200} height={600} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.08)" }} />
          </div>
          <div className="grid-2" style={{ marginBottom:48, gap:40, alignItems:"center" }}>
            <div>
              <div className="section-chip">📚 Featured Resource</div>
              <h3 style={{ fontFamily:"'Nunito',sans-serif", fontWeight:900, fontSize:24, color:"#0C2340", marginBottom:14 }}>CW Reader & C-DER Books</h3>
              <p style={{ fontSize:15, color:"#5A5240", lineHeight:1.8 }}>All CW Reader and CWR books — 70+ decodable readers published by Client Work Purrrrrrr Publishing. Fiction and nonfiction titles across a wide range of topics, levels, and cultural contexts.</p>
            </div>
        ...
        <div className="container">
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(clamp(260px,28vw,340px),1fr))", gap:20 }}>
            {[
              ...
              { title:"I Can Sound Out 2 Letters", desc:"Consonant-vowel combination chart for early phonics practice with the CW Reader system.", file:"For_Teachers_I_can_sound_out_2_letters.pdf", icon:"🔤", tag:"For Teachers" },
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(clamp(260px,28vw,340px),1fr))", gap:24 }}>
            {[
              { title:"Teacher's Helper", vol:"Volume 1", cover:"/images/resources/teachers-helper-vol1.webp", url:"https://heyzine.com/flip-book/0a66e4e5a7.html", color:"#DBEAFE", accent:"#1E40AF", pages:[
                { heading:"CW Reader — Jamaican Decodable & Early Readers", sub:"Teacher's Helper · Volume 1", body:"This resource provides structured lesson plans and teaching guides aligned to the Client Work programme. Designed for classroom teachers and early literacy educators.", author:"Client Name · Co-Author · Co-Author" },
                { heading:"How to Use This Book", sub:"Teacher's Guide", body:"Each lesson follows the 16-step Client Work structured format. Begin with the phoneme song, proceed through decoding activities, and close with the reading of the decodable text.", author:"Early Literacy Tool · Client Work Purrrrrrr Publishing" },
              ]},
              { title:"Teacher's Helper", vol:"Volume 2", cover:"/images/resources/teachers-helper-vol2.jpg", url:"https://heyzine.com/flip-book/01cc4943e4.html", color:"#DCFCE7", accent:"#166534", pages:[
                { heading:"CW Reader — Jamaican Decodable & Early Readers", sub:"Teacher's Helper · Volume 2", body:"A continuation of the teacher's instructional guide series. Covers phoneme sets 4–6 with extended lesson activities, assessment tools, and differentiation strategies.", author:"Client Name · Co-Author · Co-Author" },
              ...
              { title:"Pupil's Helper", vol:"Volume 1", cover:"/images/resources/pupils-helper-vol1.jpg", url:"https://heyzine.com/flip-book/c3b25db878.html", color:"#FEF3C7", accent:"#92400E", pages:[
                { heading:"CW Reader — Jamaican Decodable & Early Readers", sub:"Pupil's Helper · Volume 1", body:"A student workbook filled with phonics activities, letter-sound exercises, and early reading practice. Designed for children ages 3–6 beginning their literacy journey.", author:"Client Name · Co-Author" },
                { heading:"Welcome, Young Reader!", sub:"A Message to Students", body:"This book is for you! Every page will help you learn new sounds and words. You are going to be a great reader. Let's begin!", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"Pupil's Helper", vol:"Volume 2", cover:"/images/resources/pupils-helper-vol2.jpg", url:"https://heyzine.com/flip-book/16a9bc1676.html", color:"#FCE7F3", accent:"#9D174D", pages:[
                { heading:"CW Reader — Jamaican Decodable & Early Readers", sub:"Pupil's Helper · Volume 2", body:"Building on Volume 1, this workbook introduces more complex phoneme combinations through engaging activities, rhymes, and culturally relevant Jamaican stories.", author:"Client Name · Co-Author" },
                { heading:"What You Will Learn", sub:"Phoneme Sets 4 — 6", body:"In this volume you will practise blending longer words, reading short sentences, and recognising tricky high-frequency words. Keep going — you are doing amazing!", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"Pupil's Helper", vol:"Volume 3", cover:"/images/resources/pupils-helper-vol3.jpg", url:"https://heyzine.com/flip-book/639bcdbb20.html", color:"#EDE9FE", accent:"#5B21B6", pages:[
                { heading:"CW Reader — Jamaican Decodable & Early Readers", sub:"Pupil's Helper · Volume 3", body:"The third volume in the Pupil's Helper series. Focuses on vowel digraphs, blends, and reading fluency through structured decodable passages and comprehension activities.", author:"Client Name · Co-Author" },
                { heading:"You're Almost There!", sub:"Advanced Phoneme Practice", body:"This volume covers the final phoneme sets — including digraphs, diphthongs, and longer word patterns. You are reading real sentences and short stories now. Well done!", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"House Flood", vol:"C-DER Story Book", cover:"/images/resources/house-flood.png", url:"https://heyzine.com/flip-book/8e75d550bf.html", color:"#DBEAFE", accent:"#1E40AF", pages:[
                { heading:"House Flood", sub:"Client Work Purrrrrrr Publishing", body:"A decodable early reader story from the CWR collection. Fully phonics-aligned and culturally authentic.", author:"Author Name · Client Name" },
                { heading:"About This Book", sub:"Decodable & Early Reader", body:"House Flood is fully decodable and aligned to the Client Work phonics sequence — building fluency and confidence through culturally authentic storytelling.", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"Mr. Pete Makes Friends", vol:"C-DER Story Book", cover:"/images/resources/mr-pete-makes-friends.png", url:"https://heyzine.com/flip-book/b3e8251538.html", color:"#DCFCE7", accent:"#166534", pages:[
                { heading:"Mr. Pete Makes Friends", sub:"Client Work Purrrrrrr Publishing", body:"A decodable early reader story from the CWR collection. Fully phonics-aligned and culturally authentic.", author:"Author Name · Client Name" },
                { heading:"About This Book", sub:"Decodable & Early Reader", body:"Mr. Pete Makes Friends is fully decodable and aligned to the Client Work phonics sequence — helping children build confidence through stories they love.", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"Meet My Family", vol:"C-DER Story Book", cover:"/images/resources/meet-my-family.png", url:"https://heyzine.com/flip-book/ff1ce15d36.html", color:"#FEF3C7", accent:"#92400E", pages:[
                { heading:"Meet My Family", sub:"Client Work Purrrrrrr Publishing", body:"A decodable early reader story from the CWR collection. Fully phonics-aligned and culturally authentic.", author:"Author Name · Client Name" },
                { heading:"About This Book", sub:"Decodable & Early Reader", body:"Meet My Family is a fully decodable story aligned to the Client Work phonics sequence — building reading confidence through relatable, culturally rich narratives.", author:"Client Work Purrrrrrr Publishing · clientwork-demo.vercel.app" },
              ]},
              { title:"Client Work Lesson Framework", vol:"Teacher Reference", cover:"/images/resources/clientwork-lesson-framework.png", url:"https://heyzine.com/flip-book/2bee43b4b3.html", color:"#F0FDF4", accent:"#166634", pages:[
                { heading:"Client Work Lesson Framework", sub:"1-Hour Lesson Framework Overview", body:"The complete suggested timetable and instructional flow for delivering Client Work lessons. Essential reference for all Client Work educators.", author:"Client Work Team · Client Name" },
                { heading:"For Teacher Training Manual", sub:"Final Approved Version", body:"This framework outlines the 16-step instructional sequence within a structured 1-hour lesson — covering daily review, phonics drill, blending, fluency practice, and assessment.", author:"Client Work Team · clientwork-demo.vercel.app" },
              ]},
,
      ...
      {activeDrawer && drawer && (
        <div style={{ position:"fixed", inset:0, zIndex:1000, display:"flex" }}>
          ...
          <div style={{ width:"min(520px,100vw)", background:"white", overflowY:"auto", padding:"clamp(20px,5vw,40px) clamp(16px,4vw,32px)", boxShadow:"-8px 0 40px rgba(0,0,0,0.2)" }}>
            ...
            {activeDrawer === "All CW Reader & C-DER Books" && (
              <div style={{ marginBottom:20 }}>
          ...
          <div style={{ width:"min(520px,100vw)", background:"white", overflowY:"auto", padding:"clamp(20px,5vw,40px) clamp(16px,4vw,32px)", boxShadow:"-8px 0 40px rgba(0,0,0,0.2)" }}>
            ...
            {quoteStatus==="sent" ? (
              <div style={{ textAlign:"center", padding:"40px 20px" }}>
                ...
                <p style={{ fontSize:14, color:"#5A5240", lineHeight:1.7 }}>Thank you. The Client Work team will be in touch within 1 business day.</p>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
                ...
                <div><label style={{ display:"block", fontSize:12, fontWeight:700, color:"#0C2340", marginBottom:6 }}>Resources Needed</label><input value={quoteForm.resources} onChange={e=>setQuoteForm({...quoteForm,resources:e.target.value})} placeholder="e.g. Teacher Guides, Decodable Books, iCW" style={{ width:"100%", padding:"11px 14px", border:"1.5px solid #EDE0D0", borderRadius:10, fontSize:14, outline:"none" }} /></div>
