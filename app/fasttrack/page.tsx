...
export default function Client WorkPage() {
    ...
    <>
      <section className="section" style={{ background:"linear-gradient(135deg,#0C2340,#1A3A70)", padding:"80px 24px 60px", textAlign:"center" }}>
        <div className="container-sm">
          ...
          <h1 style={{ fontSize:"clamp(28px,5vw,48px)", fontWeight:900, color:"white", marginBottom:20 }}>About Client Work<span style={{ color:"#F5820A" }}>™</span></h1>
      ...
      <section className="section" style={{ background:"white" }} id="what-is">
        <div className="container">
          <div className="grid-2">
            ...
            <div>
              <div onClick={()=>setExpandedImg("/images/clientwork-vision.png")} style={{ cursor:"zoom-in", position:"relative" }}>
              <Image src="/images/clientwork-vision.png" alt="Building a Literate Nation: The Vision and Legacy of Client Work" width={900} height={500} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.08)" }} />
        ...
        <div className="container">
          ...
          <div className="grid-2" style={{ alignItems:"center" }}>
            <div>
              ...
              <p style={{ fontSize:15, color:"#5A5240", lineHeight:1.85, marginBottom:16 }}>Client Work© was created to build strong foundations early, before gaps widen. When children struggle to read, they fall behind in school, lose confidence, and face long-term academic and economic challenges.</p>
        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems:"center" }}>
            <div>
              ...
              <p style={{ fontSize:15, color:"#5A5240", lineHeight:1.85, marginBottom:24 }}><strong>Client Work©</strong> is adaptive and can be used across a wide range of age groups, supporting learners at different reading levels. It is also a great resource for educators and parents.</p>
        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems:"center" }}>
            <div>
              ...
              <h2 style={{ fontSize:"clamp(22px,3.5vw,34px)", fontWeight:900, color:"#0C2340", marginBottom:16 }}>What Makes Client Work Different</h2>
            ...
            <div>
              ...
              <Image src="/images/image8.png" alt="The Client Work Difference — 16-Step Instructional Journey" width={600} height={1100} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.08)" }} />
              <div style={{ position:"absolute", bottom:8, right:8, background:"rgba(0,0,0,0.5)", color:"white", fontSize:10, fontWeight:700, padding:"3px 8px", borderRadius:50 }}>🔍 Expand</div>
            </div>
            </div>
          </div>
      ...
      <section id="brand-experience" className="section" style={{ background:"linear-gradient(135deg,#0C2340,#1A3A70)" }}>
        <div className="container">
          <div style={{ textAlign:"center", marginBottom:32 }}>
            ...
            <h2 style={{ fontSize:"clamp(22px,4vw,36px)", fontWeight:900, color:"white", marginBottom:12 }}>The Client Work Train</h2>
          ...
          <div onClick={()=>setExpandedImg("/images/image11.png")} style={{ cursor:"zoom-in", position:"relative" }}>
              <Image src="/images/image11.png" alt="All Aboard the Client Work Phonics© Train!" width={1400} height={600} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.3)", marginBottom:32 }} />
              <div style={{ position:"absolute", bottom:8, right:8, background:"rgba(0,0,0,0.5)", color:"white", fontSize:10, fontWeight:700, padding:"3px 8px", borderRadius:50 }}>🔍 Expand</div>
            </div>
          <div onClick={()=>setExpandedImg("/images/train-poster.png")} style={{ cursor:"zoom-in", position:"relative" }}>
              <Image src="/images/train-poster.png" alt="The Client Work Train — Speeding Reading and Writing Success" width={1200} height={600} style={{ width:"100%", height:"auto", borderRadius:16, boxShadow:"0 8px 32px rgba(0,0,0,0.3)" }} />
              <div style={{ position:"absolute", bottom:8, right:8, background:"rgba(0,0,0,0.5)", color:"white", fontSize:10, fontWeight:700, padding:"3px 8px", borderRadius:50 }}>🔍 Expand</div>
            </div>
        </div>
      </section>
      ...
      <section className="section" style={{ background:"white" }} id="comparison">
        <div className="container">
          <div style={{ textAlign:"center", marginBottom:40 }}>
            ...
            <h2 style={{ fontSize:"clamp(22px,4vw,34px)", fontWeight:900, color:"#0C2340" }}>Client Work vs. Traditional Instruction</h2>
          </div>
            ...
            <table style={{ width:"100%", borderCollapse:"collapse", fontSize:13 }}>
              <thead>
                <tr>
                  ...
                  <th style={{ background:"#F5820A", color:"white", padding:"14px 18px", textAlign:"left", fontFamily:"'Nunito',sans-serif", fontSize:13 }}>Client Work</th>
      ...
      {/* WHY CHOOSE CLIENT WORK LITERACY */}
      <section className="section" style={{ background:"white" }} id="why-choose">
        <div className="container">
          <div style={{ textAlign:"center", marginBottom:40 }}>
            <div className="section-chip" style={{ margin:"0 auto 16px" }}>✅ Why Choose Client Work?</div>
            <h2 style={{ fontSize:"clamp(22px,4vw,36px)", fontWeight:900, color:"#0C2340" }}>Why Choose Client Work?</h2>
          </div>
      ...
      <section className="section-sm" style={{ background:"#FFF0E0", textAlign:"center" }}>
        <h2 style={{ fontSize:"clamp(20px,3vw,30px)", fontWeight:900, color:"#0C2340", marginBottom:14 }}>Ready to Experience Client Work?</h2>
      ...
      {whyOpen && (
        <div style={{ position:"fixed", inset:0, zIndex:1000, display:"flex" }}>
          ...
          <div style={{ width:"min(600px,100vw)", background:"white", overflowY:"auto", padding:"clamp(20px,5vw,40px) clamp(16px,4vw,32px)", boxShadow:"-8px 0 40px rgba(0,0,0,0.2)" }}>
            ...
            <p style={{ fontSize:14, color:"#5A5240", lineHeight:1.85, marginBottom:14 }}>Client Work© was created to address this urgent gap—by building strong reading foundations early, using structured, evidence-based instruction that helps children and their caregivers to become confident, independent readers.</p>
      ...
      {diffOpen && (
        <div style={{ position:"fixed", inset:0, zIndex:1000, display:"flex" }}>
          ...
          <div style={{ width:"min(660px,100vw)", background:"white", overflowY:"auto", padding:"clamp(20px,5vw,40px) clamp(16px,4vw,32px)", boxShadow:"-8px 0 40px rgba(0,0,0,0.2)" }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:24 }}>
              <h2 style={{ fontFamily:"'Nunito',sans-serif", fontWeight:900, fontSize:22, color:"#0C2340" }}>What Makes Client Work Different</h2>
            ...
            <p style={{ fontSize:14, color:"#5A5240", lineHeight:1.85, marginBottom:12 }}>Client Work blends research-based instruction with culturally relevant and engaging tools, including:</p>
            ...
            <Image src="/images/image9.png" alt="Client Work: Mastery Through Science & Rhythm" width={900} height={500} style={{ width:"100%", height:"auto", borderRadius:12, marginBottom:20 }} />
            <Image src="/images/image10.png" alt="Client Work: More Than a Program — Nation Building" width={600} height={1100} style={{ width:"100%", height:"auto", borderRadius:12, marginBottom:20 }} />
            <div style={{ overflowX:"auto" }}>
              <table style={{ width:"100%", borderCollapse:"collapse", fontSize:13 }}>
                <thead>
                  <tr>
                    <th style={{ background:"#0C2340", color:"white", padding:"12px 14px", textAlign:"left", fontFamily:"'Nunito',sans-serif" }}>Area</th>
                    <th style={{ background:"#F5820A", color:"white", padding:"12px 14px", textAlign:"left", fontFamily:"'Nunito',sans-serif" }}>Client Work</th>
                  </tr>
                </thead>
                <tbody>
                  {[
